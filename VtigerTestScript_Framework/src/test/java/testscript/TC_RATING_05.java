...
public class TC_RATING_05 {
	public static void main(String[] args) throws Throwable {
		...
		w.selectOption("Word of mouth", leadsource);
		WebElement industry = driver.findElement(By.name("industry"));
		w.selectOption("Chemicals", industry);
		...
		w.selectOption("Junk Lead", leadstatus);
		WebElement rating = driver.findElement(By.name("rating"));
		w.selectOption("Shutdown", rating);
