...
public class TC_ASSIGN_01 {
	public static void main(String[] args) throws Throwable, ParseException {
		...
		w.selectOption("Cold Call", leadsource);
		WebElement industry = driver.findElement(By.name("industry"));
		w.selectOption("Banking", industry);
		...
		w.selectOption("Cold", leadstatus);
	   ...
	   WebElement assigneddropdown = driver.findElement(By.name("assigned_group_id"));
		w.selectOption("3", assigneddropdown);
