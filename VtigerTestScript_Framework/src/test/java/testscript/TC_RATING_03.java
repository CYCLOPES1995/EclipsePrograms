...
public class TC_RATING_03 {
	public static void main(String[] args) throws Throwable {
		...
		w.selectOption("Employee", leadsource);
		WebElement industry = driver.findElement(By.name("industry"));
		w.selectOption("Biotechnology", industry);
		...
		w.selectOption("Contact in Future", leadstatus);
		WebElement rating = driver.findElement(By.name("rating"));
		w.selectOption("Project Cancelled", rating);
