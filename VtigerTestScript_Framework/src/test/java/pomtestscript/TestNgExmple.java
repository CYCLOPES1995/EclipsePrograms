...
public class TestNgExmple extends BaseClassUtility {
	...
	public void createLead() throws Throwable {
		...
		String actualtext = lip.getleadinfo().getText();
		Assert.assertTrue(actualtext.contains(lastname),"lead not created");
